...
- branch-scoped deployment and registration scripts under `infra/register`
...
- Real worker-pool smoke validation should continue whenever deployment or runtime assumptions change.
