...
from infra.prefect.dispatch import EnginePayload, dispatch_engine_job


def test_real_log_streaming() -> None:
...
"""
    ...
    dispatch_module = cast(Any, importlib.import_module("infra.prefect.dispatch"))

    dispatch_module.get_run_logger = cast(Any, lambda: mock_logger)

    # 3. Execute dispatch_engine_job
    payload: EnginePayload = {"command": "generate", "args": {}}
